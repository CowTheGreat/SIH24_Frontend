    ...
    <div className={Classes.profileContainer}>
      ...
      <div className={Classes.actionSection}>
        ...
        <div className={Classes.actionBox2}>
          ...
          <p>To enable 2 Factor Authentication using Google Authenticator App, please click the Enable 2FA button</p>
          <button className={Classes.actionButton} onClick={handleEnable2FA}>Enable 2FA</button>
        </div>
      </div>
      ...
      {showPopup && (
        <div className={Classes.popup}>
          <div className={Classes.popupContent}>
            ...
            <img src={qrCode} alt="Google Authenticator QR Code" className={Classes.qrImage} />
            ...
            <form onSubmit={handleSubmit}>
              ...
              />
              <button type="submit" className={Classes.submitButton}>Verify Code</button>
            </form>
