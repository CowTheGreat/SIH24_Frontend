...
const Onboarding = ({ setInput }) => {
  ...
  const [showSteps, setShowSteps] = useState(false);
  const [userName, setUserName] = useState("");
  const [showOnboarding, setShowOnboarding] = useState(true); // New state variable
  ...
  return (
    <>
      {showOnboarding &&
        !allStepsCompleted && ( // Use showOnboarding to control visibility
          <div className={Classes.onboardingContainer}>
            {!showSteps ? (
              <p key={currentTextIndex} className={Classes.fadeInText}>
                {welcomeMessages[currentTextIndex]}
              ...
              <>
                <div className={Classes.header}>
                  ...
                  <button
                    className={Classes.skipButton}
                    onClick={() => setShowOnboarding(false)} // Hide the container
                  >
                    ✖
                  </button>
                </div>
